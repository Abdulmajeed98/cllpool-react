const ContactInfo = ({ icon, title, content, href, altContent, altHref, animation }) => {
    return (
        <div className="flex-1 flex items-center justify-center" style={{ textDecoration: 'none' }}>
            ...
            <div className="flex-4">
                ...
                <a href={href} className="w-fit underline-offset-2 hover:text-sky-500 hover:decoration-sky-500 hover:underline transition-all duration-300">{content}</a> <br />
