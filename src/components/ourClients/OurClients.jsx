...
const clients = [
    {
        id: 1, logo: EmpireLogo, alt: 'logo'
    },
    {
        id: 2, logo: SpotifyLogo, alt: 'logo'
    },
    {
        id: 3, logo: EmpireLogo, alt: 'logo'
    },
    {
        id: 4, logo: EmpireLogo, alt: 'logo'
    },
    {
        id: 5, logo: EmpireLogo, alt: 'logo'
    },
    {
        id: 6, logo: EmpireLogo, alt: 'logo'
    },
]

const OurClients = () => {
    return (
        <section className="bg-slate-700 text-white px-sides py-8 scroll-mt-nav-offset" id='clients'>
